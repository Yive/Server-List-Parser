...
if($site eq "minecraftservers.org") {
    my $ua = LWP::UserAgent->new( cookie_jar => {}, agent => 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2228.0 Safari/537.36' );
    my @ips;
    for (my $i = 1; $i <= 2186; $i++) {
